...
if (!version || !/^\d+\.\d+\.\d+$/.test(version) || !tag || !privateKeyPath || !assetArguments.length) {
  throw new Error("Usage: --version X.Y.Z --tag vX.Y.Z --private-key path --output path --asset kind=path");
}
